...
(function() {
  ...
  Verifier = (function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/miles/go/src/github.com/keybase/proofs/src/base.iced",
    ...
    Verifier.prototype._check_inner_outer_match = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          err = (a = outer.type) !== (b = _this.base._type_v2(has_revoke(inner_obj.body))) ? new Error("Type mismatch: " + a + " != " + b) : (a = outer.version) !== (b = constants.versions.sig_v2) ? new Error("Bad version: " + a + " != " + b) : (a = outer.version) !== (b = inner_obj.body.version) ? new Error("Version mismatch: " + a + " != " + b) : !bufeq_secure((a = outer.hash), (b = hash_sig(inner_buf))) ? new Error("hash mismatch: " + (a != null ? a.toString('hex') : void 0) + " != " + (b != null ? b.toString('hex') : void 0)) : (a = outer.seqno) !== (b = inner_obj.seqno) ? (err = new errors.WrongSeqnoError("wrong seqno: " + a + " != " + b), err.seqno = b, err) : !compare_hash_buf_to_str((a = outer.prev), (b = inner_obj.prev)) ? new Error("wrong prev: " + (a != null ? a.toString('hex') : void 0) + " != " + b) : (a = outer.get_seq_type()) !== (b = inner_obj.seq_type || constants.seq_types.PUBLIC) ? new Error("wrong seq type: " + a + " != " + b) : null;
          return cb(err, outer);
        };
      })(this));
    };
              ...
              if (err == null) {
                (function(__iced_k) {
                  if (_this.strict && ((ours = trim(json_stringify_sorted(_this.json))) !== json_str_utf8_trimmed)) {
                    return __iced_k(err = new Error("non-canonical JSON found in strict mode (" + ours + " v " + json_str_utf8_trimmed + ")"));
                  } else {
                    (function(__iced_k) {
                      __iced_deferrals = new iced.Deferrals(__iced_k, {
                        parent: ___iced_passed_deferral,
  ...
  Base = (function() {
    ...
    Base.prototype._v_check = function(_arg, cb) {
      ...
      err = err != null ? err : !cieq((a = json != null ? (_ref2 = json.body) != null ? (_ref3 = _ref2.key) != null ? _ref3.host : void 0 : void 0 : void 0), (b = this.host)) ? new Error("Wrong host: got '" + a + "' but wanted '" + b + "'") : ((a = this._type()) != null) && ((b = json != null ? (_ref4 = json.body) != null ? _ref4.type : void 0 : void 0) !== a) ? new Error("Wrong signature type; got '" + a + "' but wanted '" + b + "'") : (a = this.seqno) && (a !== (b = json != null ? json.seqno : void 0)) ? (err = new errors.WrongSeqnoError("Wrong seqno; wanted '" + a + "' but got '" + b), err.seqno = b, err) : (a = this.prev) && (a !== (b = json != null ? json.prev : void 0)) ? new Error("Wrong previous hash; wanted '" + a + "' but got '" + b + "'") : this.seqno && (a = seq_type(json != null ? json.seq_type : void 0)) !== (b = seq_type(this.seq_type)) ? new Error("Wrong seq_type: wanted '" + b + "' but got '" + a + "'") : (key = json != null ? (_ref5 = json.body) != null ? _ref5.key : void 0 : void 0) == null ? new Error("no 'body.key' block in signature") : (section_error = this._check_sections(json)) != null ? section_error : this._v_check_key(key);
      (function(_this) {
        return (function(__iced_k) {
          if (err == null) {
            (function(__iced_k) {
    ...
    Base.prototype.generate_outer = function(_arg, cb) {
      var e, err, inner, p, prev_buf, ret, unpacked;
      inner = _arg.inner;
      ...
      if (err == null) {
        unpacked = new OuterLink({
          ...
          ignore_if_unsupported: !!(typeof this._ignore_if_unsupported === "function" ? this._ignore_if_unsupported() : void 0)
        });
        ret = unpacked.pack();
      }
